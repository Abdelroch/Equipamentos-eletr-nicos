                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Username" value="{{ $userAuthed->name }}"
                                                            disabled>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="nif" value="{{ $userAuthed->nif }}" disabled>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="phone_number" placeholder="+244 xxx xxx xxx"
                                             ...
                                             {{--    <div class="col-sm-12 col-md-12">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" class="form-control" name="password" placeholder="Senha antiga">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" class="form-control" name="new_password" placeholder="Crie uma senha nova">
                                                    </div>
                                                </div>
