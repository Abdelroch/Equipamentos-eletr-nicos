...
@section('content')
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 col-md-push-2">
                        <div id="product-main-img">
                            <div class="product-preview">
                                <img  style="max-width: 100%; height: 360px; object-fit: cover;" src="{{ $product->cover_image === null ? asset('visitor/img/no_image.png') : asset($product->cover_image)}}" alt="cover image">
                            </div>
                    ...
                    <div class="col-md-2  col-md-pull-5">
                        ...
                        @empty($product->imagens)
                            <img src="{{ asset('visitor/img/no_image.png') }}" alt="undefined" style="object-fit: cover; height: 100px;">
                        @else
                            @foreach ($product->imagens as $imagem)
                                <div class="product-preview">
                                    <img src="{{ asset($imagem) }}" alt="Imagem de {{ $product->nome }}">
    ...
    {{--                         <div>
                            ...
                            <div>
                                <h3 class="product-price">KZ {{ number_format($product->preco, 2, ',', '.') }} <del class="product-old-price">KZ{{ number_format($product->preco + 13000, 2, ',', '.') }}</del></h3>
                            ...
                            <div class="add-to-cart">
                                <div class="qty-label">
                                    ...
                                    <div class="input-number">
                                        <input type="number" disabled value="{{ $product->quantidade_disponivel }}">{{--
                        ...
                        <div class="billing-details">
                                ...
                                <form method="POST" action="{{ route('customer.store_order_negotiation') }}">
                                    ...
                                    <div class="form-group">
                                        <input class="input" type="number" name="offer" placeholder="Sua oferta" step="0.01" required>
                                        @error('offer')
                               ...
                               <!-- Alerta dinâmico -->
<div id="alert" class="alert" style="display: none; position: fixed; top: 20px; right: 20px; z-index: 1000; padding: 10px 20px; border-radius: 5px;">
    <span id="alert-message"></span>
    <button id="close-alert" style="float: right; border: none; background: none; font-size: 1.2em; cursor: pointer;">&times;</button>
</div>
...
<style>
    ...
    .btn-negotiate { background-color: #dc3545; color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer; }
    .btn-negotiate:hover { background-color: #c82333; }
    .input { width: 100%; padding: 10px; margin: 10px 0; border: 1px solid #ccc; border-radius: 5px; }
                                                            ...
                                                            <div class="newsletter">
                                                                ...
                                                                <form method="POST" action="{{ route('customer.create_account') }}">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <input class="input" type="text" name="phone_number" placeholder="Seu contacto (WhatsApp)*"
                    ...
                    <div class="col-md-5 order-details">
                        ...
                        <div class="order-summary">
                            ...
                            <div class="order-col">
                                <div><strong>TOTAL</strong></div>
                                <div><strong class="order-total">KZ {{ number_format($product->preco + 2500, 2, ',', '.') }}</strong></div>
                            </div>
                        </div>
