...
<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="nif" class="block w-full mt-1" type="text" name="nif" :value="old('nif')" maxlength="14" autocomplete="off" />
            <p class="mt-1 text-sm text-gray-500">{{ __('Pode preencher mais tarde no seu perfil, antes de negociar ou comprar.') }}</p>
