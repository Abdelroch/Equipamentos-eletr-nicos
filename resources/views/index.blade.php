                ...
                <div class="container">
                    <div class="row">
                        <div class="text-center col-md-12" style="padding: 60px 0;">
                            ...
                            <p class="text-muted">
                                Não temos produtos da marca <strong>{{ strtoupper($marcaActiva) }}</strong> no momento.
                            </p>
                            <a href="{{ route('store') }}" class="btn btn-primary">Ver todos os produtos</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="text-center col-md-12" style="padding: 60px 0;">
                            ...
                            <p class="text-muted">
                                @if ($termoPesquisa) Nenhum resultado para "{{ $termoPesquisa }}". @endif
                                @if ($categoriaActiva) Nenhum produto na categoria {{ $categoriaActiva->nome }}. @endif
                            </p>
                            <a href="{{ route('store') }}" class="btn btn-primary">Ver todos os produtos</a>
                        </div>
                    </div>
        ...
        @elseif (!$termoPesquisa && !$categoriaActiva && !$marcaActiva && $products_very_good->isEmpty())
            <div class="section">
                <div class="container">
                    <div class="row">
                        <div class="text-center col-md-12" style="padding: 60px 0;">
                            <i class="fa fa-shopping-cart" style="font-size: 48px; color: #ccc;"></i>
                            <h3>Sem produtos disponíveis</h3>
                            <p class="text-muted">O catálogo está temporariamente vazio.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        @else
            <div class="row">
                @foreach ($products_very_good as $product)
                    <div class="mb-4 col-md-4 col-xs-6">
                        <div class="product">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-name">
                                    <a href="{{ route('visitor.product.details', $product->slug) }}">
                                        {{ $product->nome }}
                                    </a>
                                </h3>
                                <h4 class="product-price">
                                    KZ {{ number_format($product->preco, 2, ',', '.') }}
                                </h4>
