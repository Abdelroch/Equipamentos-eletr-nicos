...
@section('content')
    ...
    <style>
        ...
        #section-welcome .col-md-12 h2, #section-welcome .col-md-12 h4{
            color:#FBFBFB;
                ...
                <p>Clientes Satisfeitos</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-6">
                            <div class="shop">
                                ...
                                <div class="shop-body">
                                    ...
                                    <a href="{{ route('store') }}" class="cta-btn">Visualizar <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <!-- /shop -->
                        ...
                        <div class="col-md-4 col-xs-6">
                            <div class="shop">
                                <div class="shop-img">
                                    <img src="{{ asset('visitor/img/troca-vidro-samsung-s9-plus-abcsmart.jpg')}}" alt="" id="img-style-min">
                                </div>
                                <div class="shop-body">
                                            ...
                                            @foreach ($products_very_good as $product)
                                                <div class="product">
                                                    <div class="product-img">
                                                        <img style="height: 240px; object-fit: contain;" src="{{ $product->cover_image === null ? asset('visitor/img/no_image.png') : asset($product->cover_image)}}" alt="cover image">
                                                    </div>
                                                    <div class="product-body">
                                                        <p class="product-category">{{ $product->categoria }}</p>
                                                        <h3 class="product-name"><a href="#">{{ $product->nome }}</a></h3>
                                                        <h4 class="product-price">KZ {{ number_format($product->preco, 2, ',', '.') }}<del class="product-old-price">KZ{{ number_format($product->preco + 13000, 2, ',', '.') }}</del></h4>
                                    ...
                                    <div id="tab2" class="tab-pane fade in active">
                                        <div class="products-slick" data-nav="#slick-nav-2">
                                            ...
                                            @foreach ($products_sold as $product)
                                                <div class="product">
                                                    <div class="product-img">
                                                        <img style="height: 240px; object-fit: contain;" src="{{ $product->cover_image === null ? asset('visitor/img/no_image.png') : asset($product->cover_image)}}" alt="">
                                                    </div>
                                                    <div class="product-body">
                                                        <p class="product-category">{{ $product->categoria }}</p>
                                                        <h3 class="product-name"><a href="#">{{ $product->nome }}</a></h3>
                                                        <h4 class="product-price">KZ {{ number_format($product->preco, 2, ',', '.') }}<del
                                                                class="product-old-price">KZ{{ number_format($product->preco + 13000, 2, ',', '.') }}</del></h4>
                                                        <div class="product-rating">
                                                            <i class="fa fa-star"></i>
                                                            <i class="fa fa-star"></i>
                                                            <i class="fa fa-star"></i>
                                    ...
                                    @foreach ($products_very_good->take(3) as $product)
                                        <a href="{{ route('visitor.negotiate', ['product_slug' => $product->slug]) }}">
                                            ...
                                            <div class="product-widget">
                                                <div class="product-img">
                                                    <img class="rounded" style="height: 80px; object-fit: contain;" src="{{ $product->cover_image === null ? asset('visitor/img/no_image.png') : asset($product->cover_image)}}" alt="">
                                                </div>
                                                <div class="product-body">
                                                    <p class="product-category">{{ $product->categoria }}</p>
                                                    <h3 class="product-name"><a href="#">{{ $product->nome }}</a></h3>
                                                    <h4 class="product-price">KZ{{ number_format($product->preco + 13000, 2, ',', '.') }}</del></h4>
                                                </div>
                                            </div>
                                            <!-- /product widget -->
                                        </a>
